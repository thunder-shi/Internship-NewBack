...
@Setter
@Entity
public class ViewRelStuInternship extends BaseInfo {
    // 来自 rel_stu_internship 表的字段
    ...
    @Column(columnDefinition = "int unsigned comment '志愿轮数（第1轮，第2轮）'")
    private Integer round;

    @Column(columnDefinition = "int unsigned comment '志愿排序（第1志愿，第2志愿）'")
